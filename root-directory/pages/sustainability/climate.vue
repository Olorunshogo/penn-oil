...
<script lang="ts" setup>
    ...
    useSeoMeta({
        ...
        ogImage: '/images/sustainability/climate-hero.jpg',
    ...
    <div>
            ...
            <div class="relative bg-(--dark-blue) px-(--section-px) lg:px-(--section-px-lg) py-(--section-py) lg:py-(--section-py-lg) w-full h-full">
                ...
                <div class="flex flex-col gap-16 py-20 w-full max-w-7xl mx-auto h-full">
                    ...
                    <div class="flex flex-col items-center justify-center gap-8 *:text-center text-(--white) w-full h-full">
                        ...
                        <h2 class="text-4xl lg:text-7xl  text-center font-extrabold">
                            By 2050 global population is expected to rise by 2 billion
                        </h2>
                    ...
                    <div class="flex flex-col gap-2 px-4 max-w-7xl mx-auto w-full h-full">
        ...
        <section>                  
            <div class="relative bg-(--dark-purple) px-(--section-px) lg:px-(--section-px-lg) py-(--section-py) lg:py-(--section-py-lg) w-full h-full">
                ...
                <div class="flex flex-col gap-16 py-20 w-full max-w-7xl mx-auto h-full">
                    ...
                    <div class="flex flex-col items-center justify-center md:flex-row gap-8 text-(--white) w-full max-w-4xl mx-auto h-full">
                        
                        <div class="flex flex-col gap-8 w-full max-w-sm h-full">
                            <NuxtImg
                            ...
                            <h2 class="text-3xl text-center font-extrabold">
        ...
        <section>                  
            <div class="relative bg-(--dark-blue) px-(--section-px) lg:px-(--section-px-lg) py-(--section-py) lg:py-(--section-py-lg) w-full h-full">
                ...
                <div class="flex flex-col items-center justify-center gap-20 py-20 w-full max-w-7xl mx-auto h-full">

                    <div class="flex flex-col items-center justify-center gap-8 *:text-center text-(--white) w-full h-full">
                        <h2 class="text-5xl lg:text-8xl font-extrabold">
                            Our lower carbon targets
                        </h2>
                    ...
                    <div class="grid md:grid-cols-2 gap-20 text-(--white) py-12 w-full max-w-4xl mx-auto h-full">
                        
                        <div class="flex flex-col text-center gap-8 w-full mx-auto max-w-sm h-full">
                            <p class="text-xl">
                ...
                <div class="flex flex-col items-center justify-center gap-12 py-20 w-full max-w-7xl mx-auto h-full">

                    <p class="text-3xl font-medium text-(--white) text-center">
        ...
        <section>                  
            <div class="relative bg-(--white) px-(--section-px) lg:px-(--section-px-lg) py-(--section-py) lg:py-(--section-py-lg) -mt-[11rem] w-full h-full">
                ...
                <div class="flex flex-col gap-32 py-20 w-full max-w-7xl mx-auto h-full">
                    ...
                    <NuxtImg
                        ...
                        alt="Man Wearing Brown Jacket and Using Grey Laptop"
                        loading="lazy"
                        class="relative h-100 lg:h-130 rounded-lg w-4/5 lg:w-full max-w-4xl mx-auto object-cover"
                    />                

                    <div class="flex flex-col items-center justify-center gap-12 w-full h-full">
                        <h2 class="text-6xl lg:text-8xl font-extrabold text-(--medium-blue) text-center">
                            "Many solutions will be needed to build the lower carbon energy system of the future.”
                        </h2>
